...
Begin
    ...
    #13#10 + '1. Чтобы добавить новую запись нажмите на кнопку ''' + AddSpButton.Caption + ''';' + 
    #13#10 + '2. Если вы хотите изменить какую-то запись, то выберите необходимую' + 
    #13#10 + '    строку для изменения и нажимайте на кнопку ''' + ChangeSpButton.Caption + ''';' + 
    #13#10 + '3. Если у вас много записей и вы потерялись, то нажмите на кнопку' + 
    #13#10 + '    ''' + SearchSpButton.Caption + '''. Там вы можете выбрать удобный вам критерий для поиска' + 
    #13#10 + '    и даже сразу изменить эту запись;' +
    #13#10 + '4. Если запись необходимо убрать из турнирной таблицы, то нажмите' + 
    #13#10 + '    на кнопку ''' + RemoveSpButton.Caption + '''. Для этого так же необходимо заранее выбрать' + 
    #13#10 + '    нужную строку.' + #13#10 + 
    #13#10 + 'Если вы хотите выйти, то у вас есть много вариантов, как это сделать:' + 
    #13#10 + '   - Сочетание клавишь Alt + F4;' +
    #13#10 + '   - Сочетание клавишь Ctrl + Q;' + 
    #13#10 + '   - Нажать ESCape (работает, как способ закрытия любого окна);' +
    ...
    #13#10 + '    В форме автоматически реализованы типизированный файл и файл' +
    #13#10 + '    корректур. Если вы сделали запись и закрыли форму, то всё' +
    #13#10 + '    сохранится автоматически и при запуске будет выгружено. ' + #13#10 + 
    #13#10 + 'В любой форме вы можете обратится к справке нажав клавишу F1 или' + 
    #13#10 + 'выбрав её в верхем меню.' + #13#10 + 
    #13#10 + 'В турнирной таблице записи упорядочены по убыванию рейтинга команд.' + #13#10 + 
    #13#10 + 'В случае когда набрано одинаковое кол-во очков, первой будет идти' + 
    #13#10 + 'команда, которая была записана в таблицу раньше.' + 
    #13#10 + 'Горячие клавиши:' +
    #13#10 + '   - Двойное нажатие вызовет изменения выбранной записи;' + 
    #13#10 + '   - Нажатие Delete вызовет удаление выбранной записи;' + 
    #13#10 + '   - Нажатие Insert вызовет добавление новой записи;' +
    #13#10 + '   - Нажатие ESCape закрывает текущую форму.';
